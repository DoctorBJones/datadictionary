...
```
You can also optionally add labels for unlabelled variables. You can specify all columns or only a few. You need to pass a named vector  to `var_labels` where the names correspond to columns in your dataset.
